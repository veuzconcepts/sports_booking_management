...
class _PublicView(APIView):
    ...
    # Creating a reservation takes a real court out of circulation, so this is
    # rate limited on the same scope as booking itself. Without it one script
    # could hold every court at a club for the length of the window.
